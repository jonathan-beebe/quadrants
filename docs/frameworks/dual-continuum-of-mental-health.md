...
distinct dimensions. One axis is **mental illness** (serious symptoms ↔ no
symptoms); the other is **mental wellbeing** (**languishing**, a hollow,
stagnant low-wellbeing state ↔ **flourishing**, high emotional, psychological,
and social wellbeing). Crossing them yields four quadrants: **flourishing
without illness** (what Keyes calls "complete mental health"), **languishing
without illness** (no diagnosis, yet feeling empty), **illness with low
wellbeing** (the most burdened state, sometimes labeled "struggling" or
"floundering" in later popularizations), and **flourishing with a mental
illness** (living well while managing a diagnosis). The model is used in public
health surveillance, education, and workplace mental-health programs to show
that treating illness and building wellbeing are two different jobs
([Westerhof & Keyes, 2010](https://pmc.ncbi.nlm.nih.gov/articles/PMC2866965/)).

## When was it created?

In stages, across roughly fifteen years. An early articulation appears in the
1988 report _Mental Health for Canadians: Striking a Balance_ from Health and
Welfare Canada, which defined mental health positively and depicted mental
health and mental illness on two separate continua
([CPHA](https://www.cpha.ca/public-health-approach-population-mental-wellness),
[Barry et al., in _Mental Well-Being_, Springer 2013](https://link.springer.com/chapter/10.1007/978-94-007-5195-8_1)).
The model as it is known today was formalized by Corey Keyes in two papers:
[Keyes 2002, "The Mental Health Continuum: From Languishing to Flourishing in Life"](https://www.semanticscholar.org/paper/The-Mental-Health-Continuum:-from-languishing-to-in-Keyes/c8d11ed1a76147dced36ecd14f1bd191270180f4)
(_Journal of Health and Social Behavior_, 43, 207–222), which defined and
measured flourishing and languishing, and
[Keyes 2005, "Mental Illness and/or Mental Health? Investigating Axioms of the Complete State Model of Health"](https://pubmed.ncbi.nlm.nih.gov/15982151/)
(_Journal of Consulting and Clinical Psychology_, 73(3), 539–548), which
supplied the confirmatory factor analysis showing illness and wellbeing form
separate, correlated dimensions.
[Westerhof & Keyes 2010](https://pmc.ncbi.nlm.nih.gov/articles/PMC2866965/)
consolidated the framework under the name "the two continua model."

## Who created it?

[Corey L. M. Keyes](https://en.wikipedia.org/wiki/Corey_Keyes), an American
sociologist at Emory University, is the model's principal creator: he coined
**flourishing** and **languishing** as mental-health terms, built the Mental
Health Continuum measures, and did the empirical work that turned a two-continua
intuition into a tested model
([Wikipedia: Corey Keyes](https://en.wikipedia.org/wiki/Corey_Keyes),
[Wikipedia: Flourishing](https://en.wikipedia.org/wiki/Flourishing)). The
provenance has honest caveats, though. The two-continua idea itself predates
him: Health and Welfare Canada's 1988 _Striking a Balance_ report drew mental
health and mental illness as separate continua years before Keyes's papers
([CPHA](https://www.cpha.ca/public-health-approach-population-mental-wellness)),
and Keyes's own positive-mental-health constructs build on Marie Jahoda's 1958
positive mental health work and Carol Ryff's psychological wellbeing model
([Westerhof & Keyes, 2010](https://pmc.ncbi.nlm.nih.gov/articles/PMC2866965/)).
Some sources also credit the quadrant diagram to Keyes & Lopez's 2002 handbook
chapter. The fairest summary: Canada's health ministry sketched the idea; Keyes
named it, operationalized it, and proved it. Wikipedia has articles on
[Corey Keyes](https://en.wikipedia.org/wiki/Corey_Keyes) (which shows the two
continua diagram) and on
[Flourishing](https://en.wikipedia.org/wiki/Flourishing), but no standalone
article exists for the dual-continuum model itself.

## What problem were they trying to solve?

Psychiatry and health policy had long operated on a single-continuum assumption:
mental health is simply the absence of mental illness, so curing illness
produces health. Keyes argued this conflates two different things. His 2002
study of the Midlife in the United States survey (n = 3,032) found that only
17.2% of adults were flourishing while 12.1% were languishing — a state with no
diagnosis but elevated risk of depression, lost workdays, and impaired
functioning
([Keyes 2002](https://www.semanticscholar.org/paper/The-Mental-Health-Continuum:-from-languishing-to-in-Keyes/c8d11ed1a76147dced36ecd14f1bd191270180f4)).
The 2005 paper then showed statistically that illness and wellbeing measures
load on separate correlated factors, so removing symptoms does not by itself
produce flourishing ([Keyes 2005](https://pubmed.ncbi.nlm.nih.gov/15982151/)).
The problem being solved was a blind spot: a system that could see the diagnosed
14% but not the languishing 12% who had no diagnosis and no help, and that
assumed treatment alone would deliver wellbeing
([Keyes 2014, "Mental Health as a Complete State"](https://globalhealth.duke.edu/sites/default/files/event-attachments/mental_health_as_a_complete_state_-_keyes_2014.pdf)).

## Why should someone use it?

- It replaces a false binary ("mentally ill or fine") with a truer map: you can
  be symptom-free yet languishing, or diagnosed yet flourishing, and each
  quadrant implies a different kind of support
  ([Westerhof & Keyes, 2010](https://pmc.ncbi.nlm.nih.gov/articles/PMC2866965/)).
- It is destigmatizing: a diagnosis stops being a verdict on a whole life,
  because wellbeing remains a separate, improvable dimension — a framing widely
  used in recovery-oriented care
  ([NCBI Bookshelf, _Health Promotion in Health Care_](https://www.ncbi.nlm.nih.gov/books/NBK585669/)).
- It gives languishing a name. Naming the "hollow and empty" state makes it
  visible to individuals and to population surveillance, and languishing
  predicts later mental illness, making it an actionable early-warning signal
  ([positivepsychology.com](https://positivepsychology.com/languishing/)).
- It rests on an unusually strong evidence base for a quadrant model: nationally
  representative samples, confirmatory factor analysis, and replication across
  countries and age groups
  ([Keyes 2005](https://pubmed.ncbi.nlm.nih.gov/15982151/),
  [Westerhof & Keyes, 2010](https://pmc.ncbi.nlm.nih.gov/articles/PMC2866965/)).
- It is already institutional practice: Keyes's measures have been adopted by
  the CDC and the Public Health Agency of Canada for national monitoring
  ([Wikipedia: Corey Keyes](https://en.wikipedia.org/wiki/Corey_Keyes)), and the
  dual-continuum diagram anchors mental-health literacy curricula
  ([BCcampus, _Framework for Evaluating Mental Health and Wellness Education_, Appendix B](https://opentextbc.ca/mhwframework/back-matter/appendix-b/)).

## What is the expected outcome?

For an individual or a practitioner, the expected outcome is a two-question
assessment instead of one — "how severe are symptoms?" and "how present is
wellbeing?" — leading to two complementary strategies: treatment to move along
the illness axis, and wellbeing-building (purpose, connection, contribution) to
move toward flourishing. The evidence says this dual effort pays: flourishing
individuals, with or without illness, show better functioning, fewer missed
workdays, and lower future illness risk than languishing ones, while treating
symptoms alone leaves people short of complete mental health
([Keyes 2005](https://pubmed.ncbi.nlm.nih.gov/15982151/),
[Keyes 2014](https://globalhealth.duke.edu/sites/default/files/event-attachments/mental_health_as_a_complete_state_-_keyes_2014.pdf)).
At the population level, the expected outcome is policy that promotes and
protects positive mental health across the whole population rather than only
treating the diagnosed — the approach now embedded in Canadian and WHO-aligned
public-health frameworks
([Westerhof & Keyes, 2010](https://pmc.ncbi.nlm.nih.gov/articles/PMC2866965/),
[CPHA](https://www.cpha.ca/public-health-approach-population-mental-wellness)).
The sober caveat: flourishing is the minority outcome in every measured
...
- [Keyes, C. L. M. (2002). The Mental Health Continuum: From Languishing to Flourishing in Life. _Journal of Health and Social Behavior_, 43, 207–222 (Semantic Scholar record)](https://www.semanticscholar.org/paper/The-Mental-Health-Continuum:-from-languishing-to-in-Keyes/c8d11ed1a76147dced36ecd14f1bd191270180f4)
  — the paper that defined and measured flourishing and languishing
...
- [Canadian Public Health Association — A Public Health Approach to Population Mental Wellness](https://www.cpha.ca/public-health-approach-population-mental-wellness)
  — documents the 1988 _Striking a Balance_ report and its two-continua figure
- [Barry, M. et al. — Promoting and Protecting Positive Mental Health (Springer chapter)](https://link.springer.com/chapter/10.1007/978-94-007-5195-8_1)
  — situates the 1988 Canadian definition in mental-health promotion history
- [NCBI Bookshelf — A Salutogenic Mental Health Model, in _Health Promotion in Health Care_](https://www.ncbi.nlm.nih.gov/books/NBK585669/)
  — flourishing as a metaphor for good mental health in care settings
